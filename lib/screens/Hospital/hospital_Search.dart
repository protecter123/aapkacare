...
class _HospitalSearchState extends State<HospitalSearch> {
  ...
  void _filterCityNames(String query) {
    setState(() {
      filteredCityDetails = cityDetails.entries.where((entry) => entry.key.toLowerCase().contains(query.toLowerCase())).map((entry) => MapEntry(entry.key, "")).toList();
    });
  }
  ...
  void _selectCityName(String cityName) async {
    ...
    try {
      ...
      QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('AllHospital').where('city', isEqualTo: cityName).get();
      print(snapshot.docs);
  ...
  void _filterDetails(String query) {
    setState(() {
      filteredDetails = cityDetails[locationController.text]!.where((detail) => detail.toLowerCase().contains(query.toLowerCase())).toList();
    });
  }
            ...
            Container(
              ...
              child: Column(
                children: [
                                              ...
                                              Navigator.push(
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) => HospitalDetails(
                                                      hospitalName: locationController.text.toString(),
                                                    ),
                                                  ));
                                            },
                                            child: Container(
                  ...
                  //                         height: 5,
                  //                       ),
                  //                       Text('Order Medicines', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  //                     ],
                  //                   ),
                  //                   _buildDivider(),
                  //                   Column(
                  ...
                  //                         height: 5,
                  //                       ),
                  //                       Text('View medical records', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  //                     ],
                  //                   ),
                  //                   _buildDivider(),
                  //                   Column(
                  ...
                  //                         height: 5,
                  //                       ),
                  //                       Text('Book test', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  //                     ],
                  //                   ),
                  //                   _buildDivider(),
                  //                   Column(
                  ...
                  //                         height: 5,
                  //                       ),
                  //                       Text('Read articles', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  //                     ],
                  //                   ),
                  //                   _buildDivider(),
                  //                   Column(
                  ...
                  //                         height: 5,
                  //                       ),
                  //                       Text('For healthcare providers', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  //                     ],
                  //                   ),
                  //                 ],
                  //               ),
