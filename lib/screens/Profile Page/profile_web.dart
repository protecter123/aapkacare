...
class DoctorWeb extends StatefulWidget {
  ...
  final String? image;
  final String? uId;
  const DoctorWeb({super.key, this.specification,  this.city, required this.name,  this.image, this.uId});
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Image.network(widget.image ?? 'assets/d3.png', fit: BoxFit.cover),
                    ),
                    Row(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            DoctorDetailed(
                                              ...
                                              text: widget.specification ?? 'specification',
                                            ),
                                            10.heightBox,
                                            DoctorDetailed(
